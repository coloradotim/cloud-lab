...
const fairWeatherControls: LabControlDefinition[] = [
  ...
  },
  {
    ...
    tier: "primary",
    meaning: "Practical runtime and resolution preset.",
    expectedEffect:
      "Longer or larger runs can show delayed cloud onset and more mature evolution at higher cost.",
    unitsOrType: "S / M / L and minutes",
    configPaths: ["domain", "grid", "time.duration_seconds"],
  },
  {
...
const fairWeatherScenarios: LabScenarioDefinition[] = [
  ...
  },
  {
    ...
    keyControls: ["source-layer-humidity", "surface-heating-strength", "model-size-runtime"],
    diagnosticExpectations: [
