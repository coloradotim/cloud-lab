...
existing solvers, use `microphysics_lab` for isolated warm-cloud experiments, evaluate
PySDM there first, and delay full dynamics/microphysics coupling until both paths are
separately credible.
