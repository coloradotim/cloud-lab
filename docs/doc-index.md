...
- `docs/reference-models/cm1-lower-atmosphere-validation-matrix.md` — staged CM1 validation matrix for Lower Atmosphere user controls, including Phase A/B/C/D/E cases, cloud timing/base/top metrics, agreement policy, validated-range policy, and #223 recommendation.
