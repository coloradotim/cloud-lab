...
EDUCATIONAL_SOLVER_TYPE = "educational_2d"
EDUCATIONAL_SOLVER_NOTICE = (
    "Educational 2-D backend for learning, UI validation, and regression tests. "
    "It is not a research-grade CFD or cloud microphysics model."
)
...
def initialize_state(config: SimulationConfig) -> AtmosphereState:
    """Create deterministic initial fields for the educational warm-cloud slice."""
...
def step_state(config: SimulationConfig, state: AtmosphereState) -> AtmosphereState:
    """Advance the educational 2-D solver by one configured timestep.
